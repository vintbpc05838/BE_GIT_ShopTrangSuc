...
//                    .map(address -> new AddressDTO(address.getAddress(), address.getCity(), address.getDistrict(), address.getIsDefault()))
...
//        }
    ...
    public AccountDTO saveAccountDetails(AccountDTO accountDTO) {
        Account account = accountRepository.findByEmail(accountDTO.getEmail()).orElse(new Account());

        // Cập nhật thông tin tài khoản
        account.setFullname(accountDTO.getFullname());
        account.setPhone(accountDTO.getPhone());

        // Kiểm tra giới tính và chuyển từ Boolean sang "Nam"/"Nữ"
...
//        accountDTO.setAddresses(accountDTO.getAddresses());
        return accountDTO;
    }
